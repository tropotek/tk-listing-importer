 ...
 * Parse the Lisitngs exporter file
 *
 * @package WordPress
 * @subpackage Importer
 */
...
class Tk_Parser {
	function parse( $file ) {
		...
		if ( extension_loaded( 'simplexml' ) ) {
			$parser = new Tk_Parser_SimpleXML;
...
class Tk_Parser_SimpleXML {
	function parse( $file ) {
		...
		if ( ! $wxr_version )
			return new WP_Error( 'Tk_parse_error', __( 'This does not appear to be a WXR file, missing/invalid WXR version number', 'wordpress-importer' ) );
